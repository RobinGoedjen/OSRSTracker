...
public class PlayerStats {
    ...
    private static final int[] EXPERIENCES= {
            ...
            127110260, 140341028, 154948977, 171077457, 188884740, 200000000, 200000001
    };

    public Map<Skill, Integer> skillRankMap = new HashMap<>();
    public Map<Skill, Integer> skillExperienceMap = new HashMap<>();
